...
exports['classic after end assert 3'] = `
TAP version 13
# assert after end
    ok 1 - passed
    1..1
...
exports['classic after end assert 4'] = `
Brittle: Fatal Error
TestError: assert after end in assert after end
    at file:///classic-after-end-assert.js:13:37 {
  code: 'ERR_ASSERT_AFTER_END',
...
# inverted
    not ok 1 - failed
      ...
      source: |
        ...
        await assert.end()
      stack: |-
        fixtures/inverted-fail.js:13:37
      ...
...
# classic, no plan
    not ok 1 - failed
      ...
      stack: |-
        fixtures/classic-fail.js:13:37
        fixtures/classic-fail.js:13:37
      ...
...
exports['classic after end teardown 3'] = `
TAP version 13
# teardown after end
    ok 1 - passed
    1..1
...
exports['classic after end teardown 4'] = `
Brittle: Fatal Error
TestError: teardown must be called before test ends
    at file:///classic-after-end-teardown.js:13:37 {
  code: 'ERR_TEARDOWN_AFTER_END',
...
exports['inverted after end teardown 3'] = `
TAP version 13
# teardown after end
    ok 1 - passed
    1..1
...
exports['inverted after end teardown 4'] = `
Brittle: Fatal Error
TestError: teardown must be called before test ends
    at file:///inverted-after-end-teardown.js:13:37 {
  code: 'ERR_TEARDOWN_AFTER_END',
...
exports['inverted after end assert 3'] = `
TAP version 13
# assert after end
    ok 1 - passed
    1..1
...
exports['inverted after end assert 4'] = `
Brittle: Fatal Error
TestError: assert after end in assert after end
    at file:///inverted-after-end-assert.js:13:37 {
  code: 'ERR_ASSERT_AFTER_END',
...
ok 2 - passing (custom messages) # time=1.3371337ms
    ...
    not ok 1 - failed
      ...
      source: |-2
          assert.fail()
        ---------^
      stack: fixtures/inverted-assertions.js:13:37
      ...
...
ok 2 - passing (custom messages) # time=1.3371337ms
    ...
    not ok 1 - failed
      ...
      source: |-
        ...
        ---------^
      stack: |-
        fixtures/classic-assertions.js:13:37
        fixtures/classic-assertions.js:13:37
      ...
