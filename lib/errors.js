...
const ERR_COMMENT_AFTER_END = ({ description, comment }) => `comment ("${comment}") after end in "${description}"`
...
const ERR_SNAPSHOT_MATCH_FAILED = 'snapshot match failed'
