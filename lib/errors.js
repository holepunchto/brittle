...
const IGNORE = typeof __filename === 'string' ? isWindows ? [__filename, __filename.replace(/lib\\errors\.js$/, 'index.js')] : [__filename, __filename.replace(/lib\/errors\.js$/, 'index.js')] : []
