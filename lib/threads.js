...
// Threads are bundled from the specifiers this process has already resolved, so
// anything a thread requires on demand must be resolved here to be included.
require.resolve('./errors.js')
require.resolve('tmatch')
